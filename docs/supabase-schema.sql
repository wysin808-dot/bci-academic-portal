...
CREATE TABLE IF NOT EXISTS subjects (
  ...
  list_type TEXT CHECK (list_type IN ('A', 'B')),
  hemisphere TEXT DEFAULT 'NH' CHECK (hemisphere IN ('NH', 'SH')),
  status TEXT DEFAULT 'active',
  created_at TIMESTAMPTZ DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS wace_outline_templates (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  subject_code TEXT NOT NULL,
  subject_name TEXT NOT NULL,
  course_type TEXT NOT NULL DEFAULT 'ATAR' CHECK (course_type IN ('ATAR', 'General', 'Foundation')),
  assessment_type TEXT NOT NULL,
  weight_min NUMERIC NOT NULL CHECK (weight_min > 0),
  weight_max NUMERIC NOT NULL CHECK (weight_max <= 100),
  created_at TIMESTAMPTZ DEFAULT now(),
  UNIQUE(subject_code, course_type, assessment_type)
);
...
CREATE INDEX IF NOT EXISTS idx_wace_outline_templates ON wace_outline_templates(subject_code, course_type);
...
ALTER TABLE wace_outline_templates ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Staff can read outline templates" ON wace_outline_templates FOR SELECT TO authenticated USING (is_staff());
CREATE POLICY "Admin staff can manage outline templates" ON wace_outline_templates FOR ALL TO authenticated USING (is_admin_staff()) WITH CHECK (is_admin_staff());
...
INSERT INTO wace_outline_templates (subject_code, subject_name, course_type, assessment_type, weight_min, weight_max) VALUES
  ('AEACC', 'Accounting and Finance', 'ATAR', 'Response', 30, 40),
  ('AEACC', 'Accounting and Finance', 'ATAR', 'Test', 20, 30),
  ('AEACC', 'Accounting and Finance', 'ATAR', 'Examination', 35, 45),
  ('AEBME', 'Business Management and Enterprise', 'ATAR', 'Investigation', 20, 30),
  ('AEBME', 'Business Management and Enterprise', 'ATAR', 'Response', 25, 35),
  ('AEBME', 'Business Management and Enterprise', 'ATAR', 'Examination', 35, 45),
  ('AECHE', 'Chemistry', 'ATAR', 'Investigation', 15, 25),
  ('AECHE', 'Chemistry', 'ATAR', 'Test', 25, 35),
  ('AECHE', 'Chemistry', 'ATAR', 'Examination', 40, 55),
  ('AEECO', 'Economics', 'ATAR', 'Investigation', 15, 25),
  ('AEECO', 'Economics', 'ATAR', 'Response', 25, 35),
  ('AEECO', 'Economics', 'ATAR', 'Examination', 40, 50),
  ('AEENG', 'English', 'ATAR', 'Response', 25, 35),
  ('AEENG', 'English', 'ATAR', 'Production', 25, 35),
  ('AEENG', 'English', 'ATAR', 'Examination', 35, 45),
  ('AEELD', 'English as an Additional Language or Dialect', 'ATAR', 'Response', 25, 35),
  ('AEELD', 'English as an Additional Language or Dialect', 'ATAR', 'Production', 25, 35),
  ('AEELD', 'English as an Additional Language or Dialect', 'ATAR', 'Examination', 35, 45),
  ('AEHBY', 'Human Biology', 'ATAR', 'Investigation', 15, 25),
  ('AEHBY', 'Human Biology', 'ATAR', 'Test', 25, 35),
  ('AEHBY', 'Human Biology', 'ATAR', 'Examination', 40, 55),
  ('AEMAA', 'Mathematics Applications', 'ATAR', 'Response', 35, 45),
  ('AEMAA', 'Mathematics Applications', 'ATAR', 'Investigation', 15, 25),
  ('AEMAA', 'Mathematics Applications', 'ATAR', 'Examination', 35, 45),
  ('AEMAM', 'Mathematics Methods', 'ATAR', 'Response', 35, 45),
  ('AEMAM', 'Mathematics Methods', 'ATAR', 'Investigation', 15, 25),
  ('AEMAM', 'Mathematics Methods', 'ATAR', 'Examination', 35, 45),
  ('AEPHY', 'Physics', 'ATAR', 'Investigation', 15, 25),
  ('AEPHY', 'Physics', 'ATAR', 'Test', 25, 35),
